...
var require = {
	app: {
		analytics: true,
		copyright: "2013 by ericwooley",
		deployType: "development",
		description: "not specified",
		guid: "d45ad252-7c9c-4cf6-82ee-a592a215d0a2",
		id: "com.menplusone.WineApp",
		name: "Mobile_Web_App",
		names: {},
		publisher: "ericwooley",
		url: "http://menplusone.com",
		version: "1"
	},
	has: {
...
require("Ti/App/Properties", function(p) {
	p.setString("acs-oauth-secret-production","iTHIbBoo0Agauy1VaOOZ4XgDIWYUopzR");
	p.setString("acs-oauth-key-production","gflksmunLeoLaiPgR0XI3VI0m58P1SKa");
	p.setString("acs-api-key-production","MPWqQnoSxNIpLmzeKvhPDsSk57Rg9Bhe");
