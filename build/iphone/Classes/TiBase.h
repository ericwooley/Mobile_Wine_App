...
// in simulator we redefine to format for Wine_App Developer console
...
{\
	NSString * exceptionName = [@"org.wine_app." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.wine_app";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIWine_AppNativeItemNone = -1, 
	UIWine_AppNativeItemSpinner = -2,
	UIWine_AppNativeItemProgressBar = -3,
	
	UIWine_AppNativeItemSlider = -4,
	UIWine_AppNativeItemSwitch = -5,
	UIWine_AppNativeItemMultiButton = -6,
	UIWine_AppNativeItemSegmented = -7,
	
	UIWine_AppNativeItemTextView = -8,
	UIWine_AppNativeItemTextField = -9,
	UIWine_AppNativeItemSearchBar = -10,
	
	UIWine_AppNativeItemPicker = -11,
	UIWine_AppNativeItemDatePicker = -12,
	
	UIWine_AppNativeItemInfoLight = -13,
	UIWine_AppNativeItemInfoDark = -14,
	
	UIWine_AppNativeItemDisclosure = -15,
	
	UIWine_AppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Wine_App instances of
