...
// in simulator we redefine to format for Mobile_Web_App Developer console
...
{\
	NSString * exceptionName = [@"org.mobile_web_app." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mobile_web_app";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIMobile_Web_AppNativeItemNone = -1, 
	UIMobile_Web_AppNativeItemSpinner = -2,
	UIMobile_Web_AppNativeItemProgressBar = -3,
	
	UIMobile_Web_AppNativeItemSlider = -4,
	UIMobile_Web_AppNativeItemSwitch = -5,
	UIMobile_Web_AppNativeItemMultiButton = -6,
	UIMobile_Web_AppNativeItemSegmented = -7,
	
	UIMobile_Web_AppNativeItemTextView = -8,
	UIMobile_Web_AppNativeItemTextField = -9,
	UIMobile_Web_AppNativeItemSearchBar = -10,
	
	UIMobile_Web_AppNativeItemPicker = -11,
	UIMobile_Web_AppNativeItemDatePicker = -12,
	
	UIMobile_Web_AppNativeItemInfoLight = -13,
	UIMobile_Web_AppNativeItemInfoDark = -14,
	
	UIMobile_Web_AppNativeItemDisclosure = -15,
	
	UIMobile_Web_AppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Mobile_Web_App instances of
