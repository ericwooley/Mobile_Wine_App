...
/**
 The base class for all Wine_App modules
 */
...
/**
 Wine_App Platform calls this method on startup.
 */
-(void)startup;

/**
 Wine_App Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Wine_App Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Wine_App Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Wine_App Platform calls this method on resume.
 @param sender The sender of the event.
 */
