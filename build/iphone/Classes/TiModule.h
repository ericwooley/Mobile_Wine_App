...
/**
 The base class for all Mobile_Web_App modules
 */
...
/**
 Mobile_Web_App Platform calls this method on startup.
 */
-(void)startup;

/**
 Mobile_Web_App Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Mobile_Web_App Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Mobile_Web_App Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Mobile_Web_App Platform calls this method on resume.
 @param sender The sender of the event.
 */
