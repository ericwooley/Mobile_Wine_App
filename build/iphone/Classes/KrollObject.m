...
//@interface Wine_AppObject : NSObject
//@end

@interface Wine_AppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Wine_AppObject class]])
		{
			for (NSString *key in [[(Wine_AppObject*)o modules] allKeys])
			{
