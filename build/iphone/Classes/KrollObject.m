...
//@interface Mobile_Web_AppObject : NSObject
//@end

@interface Mobile_Web_AppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Mobile_Web_AppObject class]])
		{
			for (NSString *key in [[(Mobile_Web_AppObject*)o modules] allKeys])
			{
