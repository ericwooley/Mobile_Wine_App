...
/**
 Base class for all Mobile_Web_App views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Mobile_Web_App view hierarchy (such as wrapped iOS UIViews) was touched.
