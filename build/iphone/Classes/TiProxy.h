...
//Rare exceptions to indicate a bug in the _mobile_web_app code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Mobile_Web_App proxies.
 */
