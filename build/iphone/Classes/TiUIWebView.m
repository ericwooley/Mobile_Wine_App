...
static NSString * const kMobile_Web_AppJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_mobile_web_appInjection
{
	...
	[html appendString:kMobile_Web_AppJavascript];
...
{
	// attempt to make well-formed HTML and inject in our Mobile_Web_App bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _mobile_web_appInjection]];
