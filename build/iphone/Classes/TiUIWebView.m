...
static NSString * const kWine_AppJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_wine_appInjection
{
	...
	[html appendString:kWine_AppJavascript];
...
{
	// attempt to make well-formed HTML and inject in our Wine_App bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _wine_appInjection]];
