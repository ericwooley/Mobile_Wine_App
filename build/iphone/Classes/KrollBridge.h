...
@interface Mobile_Web_AppObject : KrollCoverageObject {
#else
@interface Mobile_Web_AppObject : KrollObject {
#endif
@private
...
extern NSString * Mobile_Web_App$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Mobile_Web_AppObject *_mobile_web_app;
    KrollObject* console;
	BOOL shutdown;
